...
export const USER_LOADED_SUCCESS = 'USER_LOADED__SUCCESS';
...
export const GET_PRODUCTS_BY_ARRIVAL_SUCCESS = 'GET_PRODUCTS_BY_ARRIVAL_SUCCES';
...
export const GET_TOTAL_SUCCESS = 'GET_TOTAL_SUCCES';
export const GET_TOTAL_FAIL = 'GET_TOTAL_FAIL';
export const GET_ITEM_TOTAL_SUCCESS = 'GET_TOTAL_ITEM_SUCCES';
export const GET_ITEM_TOTAL_FAIL = 'GET_TOTAL_ITEM_FAIL';
