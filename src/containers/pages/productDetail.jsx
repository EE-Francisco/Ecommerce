...
const ProductDetail = ({
    ...
    const filterReviews = numStarts => {
        filter_reviews(productId, numStarts);
    };
                                    ...
                                    </div>
                                    {
                                        review && isAuthenticated ?
                                            <form onSubmit={e => updateReview(e)}>
                                                ...
                                                <button
                                                    type="submit"
                                                    className="mt-4 inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-indigo-600 
